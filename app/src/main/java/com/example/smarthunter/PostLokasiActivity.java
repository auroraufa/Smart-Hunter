...
import com.example.smarthunter.databinding.ActivityPostLokasiBinding;

public class PostLokasiActivity extends FragmentActivity implements OnMapReadyCallback {

    private GoogleMap mMap;
    private ActivityPostLokasiBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPostLokasiBinding.inflate(getLayoutInflater());
