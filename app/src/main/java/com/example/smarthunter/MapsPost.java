...
import com.example.smarthunter.databinding.ActivityMapsPostBinding;

import java.util.concurrent.TimeUnit;

public class MapsPost extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.OnConnectionFailedListener, LocationListener, GoogleApiClient.ConnectionCallbacks {

    private GoogleMap mMap;
    GoogleApiClient mGoogleApiClient;
    private ActivityMapsPostBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityMapsPostBinding.inflate(getLayoutInflater());
    ...
    public void onLocationChanged(Location location) {
        ...
        mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
            ...
            public void onMapClick(final LatLng point) {
                ...
                Toast.makeText(MapsPost.this, "Lat : "+latid+" Long : "+longtid, Toast.LENGTH_SHORT).show();
            }
        });
